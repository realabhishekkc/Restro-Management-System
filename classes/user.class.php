<?php
    ...
    Class User extends Connection
    {
        ...
        public function registerUser(){
            $sql = "INSERT INTO `tbl_register_user`(`u_id`, `fname`, `lname`, `e_mail`, `phone`, `address`, `city`, `gender`, `password`, `confirm_password`) VALUES (NULL, '$this->fname', '$this->lname', '$this->e_mail', '$this->phone', '$this->address', '$this->city', '$this->gender', '$this->password' , '$this->confirm_password')";
        ...
        public function updateProfile($u_id){
            $sql = "UPDATE `tbl_register_user` SET `fname`='$this->fname',`lname`='$this->lname',`e_mail`='$this->e_mail',`phone`='$this->phone',`address`='$this->address',`city`='$this->city',`gender`='$this->gender' WHERE `u_id` = '$this->u_id'";
            // echo $sql; exit;
            return $this->connect->qry($sql);
        }
