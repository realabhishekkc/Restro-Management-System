...
<head>
	...
	<title>View Orders - Restro Management System</title>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $output['p_price']; ?></td>
								            <td><a href="../action/cancelOrder-actionn.php?cancel=<?php echo $output['o_id']; ?>" class="btn btn-danger" onclick="Javascript: return confirm('Are you sure you want to reject order?');" name="productDelete">Reject Order</a></td>
                                        </tr>
                                    <?php $i++; } ?>
                                    </tbody>
                                </table>
