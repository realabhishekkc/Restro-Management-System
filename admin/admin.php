<?php
    ...
    if(isset($_GET['msg']) && $_GET['msg'] == 'loginTrue'){
        echo "<script>window.alert('Welcome to your dashboard!');</script>";
    }
...
<head>
	...
	<title>Admin Profile - Restro Management System</title>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="../action/adminUpdate-action.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
