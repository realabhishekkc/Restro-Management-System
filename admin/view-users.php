...
<head>
	...
	<title>Registered Users - Restro Management System</title>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php foreach ($data as $details) { ?>
                                        <tr>
								            ...
								            <td><a href="../action/deleteUser-action.php?delete=<?php echo $details['u_id']; ?>" class="btn btn-danger" onclick="Javascript: return confirm('Are you sure you want to delete?');" name="productDelete">Delete</a></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
