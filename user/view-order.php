                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
								            ...
								            <td><a href="../action/cancelOrder-action.php?cancel=<?php echo $output['o_id']; ?>" class="btn btn-danger" onclick="Javascript: return confirm('Are you sure you want to cancel order?');" name="productDelete">Cancel Order</a></td>
