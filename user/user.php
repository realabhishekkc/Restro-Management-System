...
<head>
	...
	<title>User Profile - Restro Management</title>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="../action/userUpdate-action.php" method="POST">
                                    <div class="row">
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input type="text" class="form-control" name="phone" placeholder="Phone" value="<?php echo $data[0]['phone']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
