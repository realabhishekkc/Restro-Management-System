<?php
    ...
    if(isset($_GET['msg']) && $_GET['msg'] == 'order-confirm'){
        echo "<script>window.alert('Order Successful. Please visit your dashborad!');</script>";
    }
    session_start();
                ...
                <?php foreach ($data as $details) { ?>
                    <div class="col-lg-3 mb-4 d-flex align-items-stretch">
                        <div class="card card-rad mx-auto">
                            <img class="card-img-top img-fluid" style="height: 200px; width: auto;" src="images/product-images/<?php echo $details['p_image']; ?>" alt="Image Card">
                            <div class="card-body cbody">
                                <h5 class="card-title text-center"><?php echo $details['p_name']; ?></h5>
                                <p class="buton text-center">
                                    <a href="productDetails.php?id=<?php echo $details['p_id']; ?>" class="btn btn-primary mb-2" style="color: #fff !important;"> Details</a>
                                    <a href="productDetails.php?id=<?php echo $details['p_id']; ?>" class="btn btn-primary mb-2" style="color: #fff !important;"> Order</a>
                                </p>
                            </div>
                        </div>
                    </div>
